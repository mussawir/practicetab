...
class coupon extends Model {
     ...
     * @throws Exception
     */
    static public function generate($length=self::MIN_LENGTH,$prefix="",$suffix="",$useLetters=true,$useNumbers=false,$useSymbols=false,$useMixedCase=false,$mask=false) {

        $options['length'] = $length;
        $options['prefix']=$prefix;
        $options['suffix']=$suffix;
        $options['letters']=$useLetters;
        $options['numbers']=$useNumbers;
        $options['symbols']=$useSymbols;
        $options['mixed_case']=$useMixedCase;
        $options['mask']=$mask;
