...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">New Email Group <small>Add Patients</small></h1>
<!-- end page-header -->
...
<div class="row">
    ...
    {!! Form::open(array('url'=>'/practitioner/email-group/addPatients', 'id'=>'frm-suggestions')) !!}
    <div class="col-md-6" style="margin-top: 44px;">
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Add Patients to List</h4>
            </div>
                    ...
                    @foreach($patients as $item)
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="sup_id[]" value="{{$item->user_id}}" {{in_array($item->user_id, $pat_ids)? 'checked="checked"' : ''}}>
                                    </label>
                                </div>
                            </td>
                        </tr>
    ...
    <script type="text/javascript">
        ...
        $('#btn-next').click(function () {
            if($('#dt-sup-selected').find('td').hasClass('dataTables_empty')){
                ...
                window.location.assign('{{url('/practitioner/email-group/patients')}}');
            }
        });
