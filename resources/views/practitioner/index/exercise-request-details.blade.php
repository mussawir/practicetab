                    ...
                    @foreach($sup_details as $srd)
                        <tr>
                            ...
                            <td>
                                <?php
                                if($srd->status == '0'){?>
                                    {!! Form::open(array('url'=>'practitioner/index/exercise-approved/'.$srd->erd_id,'class'=>'pull-left')) !!}
                                    {!! Form::submit('Approve', array('class'=>'btn btn-success btn-xs')) !!}
                                    {!! Form::close() !!}
                                    {!! Form::open(array('url'=>'practitioner/index/exercise-reject/'.$srd->erd_id,'class'=>'pull-left','style'=>'position:relative;left:5px;')) !!}
