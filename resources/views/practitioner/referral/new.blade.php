...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Referral Program<small>Mew Referral</small></h1>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            ...
            <div class="panel-body">
                ...
                <hr/>
                {!! Form::open(array('url'=>'/practitioner/referral/createList', 'class'=> 'form-horizontal')) !!}
    ...
    <div class="col-md-7">
        {!! Form::open(array('url'=>'/practitioner/referral/store', 'class'=> 'form-horizontal', 'id'=>'frm-affiliate')) !!}
...
@section('page-scripts')
    <script type="text/javascript">
        ...
        function removeRow(elm, email) {
            $.get("{{url('/practitioner/referral/removeAddedMember')}}", { email: email}, function(data) {
