...
<div class="row">
    ...
    <div class="col-md-12">
        {!! Form::open(array('url'=>'/practitioner/referral/resendInvitation', 'class'=> 'form-horizontal', 'id'=>'frm-affiliate')) !!}
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    ...
                    {!! Form::submit('Resend Invitation', array('class'=>'btn btn-success pull-right')) !!}
                </div>
            </div>
        </div>
        {!! Form::close() !!}
