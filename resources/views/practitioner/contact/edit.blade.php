...
<ol class="breadcrumb pull-right">
    ...
    <li><a href="{{url('/practitioner/contact')}}">Contacts</a></li>
    <li class="active">Edit</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Contacts <small>Edit Contact</small></h1>
<!-- end page-header -->
...
<div class="row">
    ...
    {!! Form::model($contact, array('url'=>'/practitioner/contact/update', 'method' => 'PATCH', 'id'=>'frm-contact', 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true')) !!}
    <!-- begin col-8 -->
    <div class="col-md-8">
        <!-- begin panel -->
                    ...
                    @foreach($cg_list as $item)
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="cg_id[]" value="{{$item->cg_id}}" {{(checkGroupInContact($contact_groups,$item->cg_id)?'checked':'')}} />
                                    </label>
                                </div>
                            </td>
                        </tr>
...
<?php
function checkGroupInContact($groups, $contact_id){
    foreach ($groups as $key => $value) {
        if($value['cg_id'] == $contact_id){
            return true;
        }
    }
    return false;
