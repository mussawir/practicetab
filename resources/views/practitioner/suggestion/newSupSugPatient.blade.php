...
@section('content')
    ...
    <div class="row">
        ...
        {!! Form::open(array('url'=>'/practitioner/suggestion/addSugPatients', 'id'=>'frm-suggestions','data-parsley-validate' => 'true')) !!}
                        ...
                        @foreach($patients as $patient)
                            <tr>
                                ...
                                <td>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="pa_id[]" data-parsley-required="true" value="{{$patient->pa_id}}" {{in_array($patient->pa_id, $patient_ids)? 'checked="checked"' : ''}}>
                                        </label>
                                    </div>
                                </td>
                            </tr>
                        ...
                        @foreach($selected_patients as $patient)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="text-danger" onclick="removePatRow(this, '{{$patient->pa_id}}')"><i class="fa fa-times"></i> Remove</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    <script type="text/javascript">
        ...
        $('#btn-next').click(function () {
            if($('#dt-pat-selected').find('td').hasClass('dataTables_empty')){
                ...
                window.location.assign('{{url('/practitioner/suggestion/confirm-supplement-suggestions')}}');
            }
        });
