...
@section('content')
    ...
    <div class="row">
        ...
        {!! Form::open(array('url'=>'/practitioner/suggestion/addSugPatients', 'id'=>'frm-suggestions')) !!}
                        ...
                        @foreach($patients as $patient)
                            <tr>
                                ...
                                <td>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="pa_id[]" value="{{$patient->pa_id}}" {{in_array($patient->pa_id, $patient_ids)? 'checked="checked"' : ''}}>
                                        </label>
                                    </div>
                                </td>
                            </tr>
