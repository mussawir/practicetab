                    ...
                    @foreach($nutritions as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);" class="text-danger" onclick="removePatRow(this, '{{$item->nut_id}}')"><i class="fa fa-times"></i> Remove</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                ...
                <table class="table table-striped table-hover" id="dt-patient">
                    ...
                    @foreach($patients as $patient)
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="pa_id[]" value="{{$patient->user_id}}" />
                                <a href="javascript:void(0);" class="text-danger" onclick="removeSuprow(this, '{{$patient->user_id}}')"><i class="fa fa-times"></i> Remove</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
