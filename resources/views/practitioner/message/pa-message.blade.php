                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6"   id="border-right">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" id="pa_id">
                                    @foreach($patient as $values)
                                        <option value="{{$values->pa_id}}">{{$values->first_name}} {{$values->last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            </div>
                    ...
                    <table id="data-table" class="table table-striped table-hover">
                        ...
                        @foreach($messageHistory as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::to('/practitioner/message-history?chat=')}}{{$item->practitioner_id}}"><i class="fa fa-eye"></i> View</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
...
@section('page-scripts')
    <script type="text/javascript">
        ...
        appender += 'Start a conversation with ' + $("#pa_id option:selected").text();
        appender += '</p></b>';
