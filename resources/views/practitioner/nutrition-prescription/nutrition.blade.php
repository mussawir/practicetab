...
<ol class="breadcrumb pull-right">
    ...
    <li class="active">Nutrition Prescription</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Prescribe nutrition to {{ $table1->first_name }} {{ $table1->last_name }}</h1>
<!-- end page-header -->
                ...
                <table id="dt-nut" class="table table-striped table-hover">
                    ...
                    @foreach($table2 as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/practitioner/nutrition-prescription/add/'.$item->nut_id)}}"><i class="fa fa-plus"></i> Add</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
    ...
    <div class="col-md-5">
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Selected Nutrition List</h4>
            </div>
            <div class="panel-body">
                <table id="dt-selected" class="table table-striped table-hover">
                    ...
                    @foreach($nut_list as $item)
                        <tr>
                            ...
                            <td>{{$item->usability}}</td>
                            <td>
                                <a href="javascript:void(0);" onclick="doDeleteNutrition('{{$item->nut_id}}', this);" class="text-danger"><i class="fa fa-times fa-2x"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            &nbsp;
                            <a href="{{url('/practitioner/nutrition-prescription/prescribe')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Prescribe</a>
                        </td>
                    </tr>
                    </tfoot>
                </table>
...
@section('page-scripts')
    <script type="text/javascript">
        ...
        function doDeleteNutrition(id, elm)
        {
            $.ajax({
                    type: "DELETE",
                    url: '{{ url('/practitioner/nutrition-prescription/delete') }}/' + id,
