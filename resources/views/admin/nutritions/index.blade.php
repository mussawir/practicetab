...
<ol class="breadcrumb pull-right">
    ...
    <li class="active">Nutrition List</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Nutrition List <small></small></h1>
<!-- end page-header -->
                        ...
                        <tr>
                            <td>
                                @if(isset($item->main_image) && (!empty($item->main_image)))
                                    <img src="{{asset('public/dashboard/img/nutrition/'.$item->main_image)}}" alt="{{$item->name}}" class="img-responsive" style="max-height: 100px;" />
                                @else
                            ...
                            <td>
                                <a href="{{url('/admin/nutrition/edit/'.$item->nut_id)}}"><i class="fa fa-pencil"></i> Edit</a> |
                                <a id="delete_{{$item->nut_id}}" href="javascript:void(0);" onclick="doDelete('{{$item->nut_id}}', this);"><i class="fa fa-trash-o"></i> Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
...
@section('page-scripts')
    <script type="text/javascript">
        ...
        {
            //var q = confirm("Are you sure you want to delete this nutrition?");
            //if (q == true)
            {

                $.ajax({
                    type: "DELETE",
                    url: '{{ URL::to('/admin/nutrition/destroy') }}/' + id,
