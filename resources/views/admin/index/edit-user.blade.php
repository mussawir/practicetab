...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Users <small>Edit User</small></h1>
<!-- end page-header -->
...
<div class="row">
    ...
    {!! Form::model($user, array('url'=>'/admin/index/updateUser','method'=>'PATCH' ,'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true'
)) !!}
            <!-- begin col-8 -->
    <div class="col-md-12">
        <!-- begin panel -->
