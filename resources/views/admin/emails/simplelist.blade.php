...
<ol class="breadcrumb pull-right">
    ...
    <li class="active">Sent Email List</li>
</ol><!-- end breadcrumb -->
<!-- begin page-header -->
                ...
                <table id="dt_list" class="table table-striped table-hover">
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-info" onclick="window.location.href='{{url('/admin/emails/sent_list_details/'.$item->ae_id)}}'">View</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
