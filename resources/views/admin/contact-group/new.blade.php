...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Contact Groups <small>Create New Contact Group</small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
            ...
            <div class="panel-body">
                {!! Form::open(array('url'=>'/admin/contact-group/store', 'class'=> 'form-horizontal','data-parsley-validate' => 'true')) !!}
