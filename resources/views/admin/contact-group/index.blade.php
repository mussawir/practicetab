...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Contact Groups <small></small></h1>
<!-- end page-header -->
                ...
                <table id="data-table" class="table table-striped table-hover">
                    ...
                    @foreach($cg_list as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/admin/contact-group/edit/'.$item->ag_id)}}"><i class="fa fa-pencil"></i> Edit</a> |
                                <a href="javascript:void(0);" onclick="doDelete('{{$item->ag_id}}', this);"><i class="fa fa-trash-o"></i> Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
    ...
    <script type="text/javascript">
        ...
        function doDelete(id, elm)
        {
            ...
            if (q == true) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: '{{ URL::to('/admin/contact-group/destroy') }}/' + id,
