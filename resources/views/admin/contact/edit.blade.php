...
<div class="row">
    ...
    {!! Form::model($contact, array('url'=>'/admin/contact/update', 'method' => 'PATCH', 'id'=>'frm-contact', 'class'=> 'form-horizontal', 'files'=>true,'data-parsley-validate' => 'true')) !!}
    <!-- begin col-8 -->
    <div class="col-md-7">
        <!-- begin panel -->
                    ...
                    @foreach($cg_list as $item)
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="cg_id[]" value="{{$item->ag_id}}" {{(checkGroupInContact($contact_groups,$item->ag_id)?'checked':'')}} />
                                    </label>
                                </div>
                            </td>
                        </tr>
