...
@section('content')
    <section>
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Nutrition Request</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Nutrition Request <small></small></h1>
        <!-- end page-header -->

        {!! Form::open(array('url'=>'/patient/index/saveNutritionRequest','data-parsley-validate' => 'true')) !!}
        <div class="row">
            <div class="col-md-6">
